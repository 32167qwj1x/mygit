...
public class ContinueFTP {
	...
	public String upload(String local, String remote) throws IOException {
		...
		if (remote.contains("/")) {
			...
			if (CreateDirecroty(remote, ftpClient) == "Create_Directory_Fail") {
